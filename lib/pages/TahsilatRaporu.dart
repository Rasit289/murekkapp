...
class TahsilatRaporu extends StatefulWidget {
  const TahsilatRaporu({super.key});

  @override
  State<TahsilatRaporu> createState() => _TahsilatRaporuState();
}

class _TahsilatRaporuState extends State<TahsilatRaporu> {
  ...
  //tahsilat raporunun işlemlerinin bulunduğu kısım
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        //daha önceden eklenen faturaların aranması
                        Container(
                          height: 70,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Slidable(
                                          ...
                                          child: TahsilatRaporuContainer(
                                              firma5: tahsilatRaporuTest[index]
                                                      [0]
                                                  .toString(),
                                              musteriBelgeTutariYazi5:
                                                  tahsilatRaporuTest[index][1]
                                                      .toString(),
                                              belgeNoTahsilat:
                                                  tahsilatRaporuTest[index][2]
                                                      .toString(),
                                              tahsilatTarihi:
                                                  tahsilatRaporuTest[index][3]
                                                      .toString(),
                                              VadeDurumu:
                                                  tahsilatRaporuTest[index][4]
                                                      .toString())),
                                    ),
                                  );
                                }),
