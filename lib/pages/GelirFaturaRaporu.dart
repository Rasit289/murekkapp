...
class GelirFaturaRaporu extends StatefulWidget {
  const GelirFaturaRaporu({super.key});

  @override
  State<GelirFaturaRaporu> createState() => _GelirFaturaRaporuState();
}

class _GelirFaturaRaporuState extends State<GelirFaturaRaporu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            //Gelir Fatura Raporunundaki "Vergisiz Toplam Gelir Belgeleri Tutarı" kısmınınn düzenlendği Container

            Container(
              child: GelirFaturaRaporDegerler(),
            ),
           
            //Gelir Fatura Raporu Oluşturduğumuz Container
                        ...
                        return SizedBox(
                          ...
                          child: Center(
                            //faturalar kartının kaydırılmasının sağlayan slidable
                              ...
                              child: FaturalarOrnek(firma3: FaturalarDropDownTest[index][0].toString(),
                               FaturaNumrasi: FaturalarDropDownTest[index][1].toString(),
                               musteriBelgeTutariYazi4: FaturalarDropDownTest[index][2].toString(),
                               tarihTahsilat1:FaturalarDropDownTest[index][3].toString(),)),)
                        );
                      }),
                       //önceden eklenen Müşterilerin bulunduğu kısım
                  ListView.builder(
                      shrinkWrap: true,
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return SizedBox(
                          ...
                          child: Center(
                             ...
                             //müşteri kısmının oluşturulduğu ve bilgilerinin girildiği yer
                              child: musteriRapor(firmaAd:   musteriRaporTest[index][0].toString(),
                               musteriNumber: musteriRaporTest[index][1].toString(),
                                musteriEposta: musteriRaporTest[index][2].toString(),
                                 vergiDiresi: musteriRaporTest[index][3].toString(),
                                  TCnumarasi: musteriRaporTest[index][4].toString(), 
                                  musteriBakiye: musteriRaporTest[index][5].toString(),)),)
                        );
                      }),
                              ...
                              key: const ValueKey(0),
                                    ...
                                    children: [
                                      ...
                                      endActionPane: ActionPane(
                                         ...
                                         //müşteri ve hizmetler kısmının oluşturulduğu ve bilgilerinin girildiği yer
                              child: musteriRapor(firmaAd:   hizmetRaporTest[index][0].toString(),
                               musteriNumber: hizmetRaporTest[index][1].toString(),
                                musteriEposta: hizmetRaporTest[index][2].toString(),
                                 vergiDiresi: hizmetRaporTest[index][3].toString(),
                                  TCnumarasi: hizmetRaporTest[index][4].toString(), 
                                  musteriBakiye: hizmetRaporTest[index][5].toString(),)),)
                        );
                      }),
